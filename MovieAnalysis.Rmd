...
### Correlations Across Variables
We have seen that ratings across different genres exhibit different correlations, but it would be good to have a more formal proof to check if the distributions of votes are the same among these different categories. For this we can use the Mann–Whitney–Wilcoxon statistic, which will test for:
